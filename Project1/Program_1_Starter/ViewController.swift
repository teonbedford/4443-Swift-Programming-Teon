...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        colorNumber = Int(arc4random_uniform(UInt32(myColors.fetchColorCount())))
        while colorNumber == lastColorNumber { //changed from lastbuttonnumber to last colornumber
            colorNumber = Int(arc4random_uniform(UInt32(myColors.fetchColorCount())))
        }
        ...
        if(buttonAnswer == 0){
            btnAnswer1OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[color].hexValue), forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[prev].hexValue), forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[next].hexValue), forState: UIControlState.Normal)
            button1Correct = true;
            
        }
        
        if(buttonAnswer == 1){
            btnAnswer1OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[prev].hexValue), forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[color].hexValue), forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[next].hexValue), forState: UIControlState.Normal)
            button2Correct = true
        }
        
        if(buttonAnswer == 2){
            btnAnswer1OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[next].hexValue), forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[prev].hexValue), forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(myColors.fetchColorName(myColors.colorsTupleArray[color].hexValue), forState: UIControlState.Normal)
            button3Correct = true
        }
    ...
    func changeColor() -> Bool{
        ...
        lblChangeColor.backgroundColor = myColors.hexStringToUIColor(myColors.colorsTupleArray[colorNumber].hexValue)
